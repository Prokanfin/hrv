...
(function(document, window, $) {
 ...
 $("#finnishForm").formValidation({
    ...
    wizard.get("#workData").setValidator(function() {
      var fv = $("#workDataForm").data('formValidation');
      fv.validate();
    ...
    wizard.get("#document").setValidator(function() {
    ...
    // data_personnel customer 
    wizard.get("#companyData").setValidator(function() {
      var fv = $("#companyForm").data('formValidation');
      fv.validate();
      ...
      wizard.get("#contactData").setValidator(function() {
      ...
      wizard.get("#singData").setValidator(function() {
      var fv = $("#singForm").data('formValidation');
      fv.validate();
      ...
      return true;
       ...
       wizard.get("#addressData").setValidator(function() {
      var fv = $("#addressForm").data('formValidation');
      fv.validate();
  ...
  (function() {
    ...
    var options = $.extend(true, {}, defaults, {
      ...
      onFinish: function() {
        // $('#exampleAccountForm').submit();
        // $('#exampleBillingForm').submit();
        // $('#workDataForm').submit();
        // $('#documentForm').submit();
       alert('finish');
      },
